		...
		<div id="remove">
			<div class="form">
				...
				if(empty($errors) === true &&  empty($_POST) === false) {
					bookOnEntrance($email, $password, $firstname, $lastname, $phone);
				...
				?>
				<form id="input-form" method="post" action="entrance.php?token=z3rGru5h">
					<h1>First name:</h1>
					...
					<input type="submit" value="Finish" id="submit-btn">
				</form>
			</div>
			<?php
